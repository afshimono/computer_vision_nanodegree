...
class robot:
    ...
    def sense(self):
        ...
        for i in range(0,len(self.landmarks)):
            measure_x = (self.landmarks[i][0] - self.x) + self.rand()*self.measurement_noise
            measure_y = (self.landmarks[i][1] - self.y) + self.rand()*self.measurement_noise
    ...
    def robot_params(self):
        return str('World Size:  ' + str(self.world_size) + '     Meas Range:   : '+str(self.measurement_range) + '     Num Landmarks:   :'+str(self.num_landmarks))
